...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="/simple_blog">Я есть блог</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/simple_blog/about">Обо мне</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/simple_blog/contact">Обратная связь</a>
                        </li>
                    </ul>
                </div>
            </div>
